...
public class CEConnection 
{
	...
	public void establishConnection(String userName, String password)
    {
        ...
        con = Factory.Connection.getConnection(EnviromentDefinitions.URI.getStringValue());
        Subject sub = UserContext.createSubject(con,userName,password,EnviromentDefinitions.STANZA.getStringValue());
        uc.pushSubject(sub);
        dom = fetchDomain();
    ...
    {
		String userName= EnviromentDefinitions.ADMIN.getStringValue();
 		String password = EnviromentDefinitions.ADMIN_PASS.getStringValue();
